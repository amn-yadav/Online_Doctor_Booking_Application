class Registration {
  ...
  Registration(this._UserName, this._EmailId, this._PhoneNo, this._Password);

  Registration.WithId( this._Id,this._UserName, this._EmailId, this._PhoneNo, this._Password);
  ...
  Registration.fromObject(dynamic o) {
